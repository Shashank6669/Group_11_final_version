...
//////HTTP Thread
    public class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try{
                URL url = new URL("http://209.2.232.184");
                ...
                else if(STT_output.compareTo("display weather")==0)
                {
                    postDataParams.put("DisplayWEATHER", "email");
                }

                else if(STT_output.compareTo("show post")==0)
                {
                    postDataParams.put("showPOST", "email");
                }

                else if(STT_output.compareTo("show weather")==0)
                {
                    postDataParams.put("showWEATHER", "email");
                }
                ...
                else if(STT_output.indexOf("post message")!=-1)
                {
                    String delimeter = "post message ";
                    String STT_output2;
                    STT_output2=STT_output.split(delimeter)[1];
                    postDataParams.put("tweet", STT_output2.toUpperCase());
                }
